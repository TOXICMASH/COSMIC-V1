...
module.exports = {
    ...
    SESSION: process.env.COSMIC_SESSION === undefined ? '' : process.env.COSMIC_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴀɴsʜɪᴅ' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '916238560742@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ⚡ℂ𝐨ˢᗰᴉℭ⚡  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸 ℂ𝐨ˢᗰᴉℭ ᦔꪮ᭙ꪀꪶꪮꪖᦔ𝓲ꪀᧁ ꪗꪮꪊ𝘳 𝘴ꪮꪀᧁ✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸 ℂ𝐨ˢᗰᴉℭ ꪊρꪶꪮꪖᦔ𝓲ꪀᧁ ꪗꪮꪊ𝘳 𝘴ꪮꪀᧁ ✮⃝🎧' : process.env.SONGU,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'Aɴsʜɪᴅ' : process.env.OWNER_SHIP,
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/SoIxkUE.jpeg' : process.env.LOGO_LINK,
    BOTV2: process.env.BOTV2_NAME === undefined ? '⚡ℂ𝐨ˢᗰᴉℭ⚡' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '⚡ℂ𝐨ˢᗰᴉℭ⚡' : process.env.LOGO_NAME,
